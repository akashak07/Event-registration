...
class It extends StatefulWidget {
  It({Key key,this.uid}):super(key:key);
  final String uid;
  @override
  _MechState createState() => _MechState();
}

class _MechState extends State<It> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("XPLOITS",style: TextStyle(color: Colors.black,fontSize: 25),),
          ...
          children: <Widget>[
                    ...
                    children: <Widget>[
                      ...
                      Container(
                          child: Column(
                            children: [
                              Container(
                                child: Text("XPLOITS' 2021",style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,color: Colors.white)) ,
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>Itevent()),
                );
              },
              child: Container(
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>Itcod()),
                );
              },
              child: Container(
                // padding: EdgeInsets.fromLTRB(10, 10, 10, 5),
...
class Itevent extends StatefulWidget {
  @override
  _CivileventState createState() => _CivileventState();
}

class _CivileventState extends State<Itevent> {
...
//coordinators
class Itcod extends StatefulWidget {
  @override
  _CivilcodState createState() => _CivilcodState();
}

class _CivilcodState extends State<Itcod> {
  showAlertDialog(BuildContext context) {
