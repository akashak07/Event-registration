...
class Ece extends StatefulWidget {
  Ece({Key key,this.uid}):super(key:key);
  final String uid;
  @override
  _MechState createState() => _MechState();
}

class _MechState extends State<Ece> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("TARAS",style: TextStyle(color: Colors.black,fontSize: 25),),
          ...
          children: <Widget>[
                    ...
                    children: <Widget>[
                      ...
                      Container(
                          child: Column(
                            children: [
                              Container(
                                child: Text("TARAS' 2021",style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,color: Colors.white)) ,
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>Eceevent()),
                );
              },
              child: Container(
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>Ececod()),
                );
              },
              child: Container(
                // padding: EdgeInsets.fromLTRB(10, 10, 10, 5),
...
class Eceevent extends StatefulWidget {
  @override
  _CivileventState createState() => _CivileventState();
}

class _CivileventState extends State<Eceevent> {
...
//coordinators
class Ececod extends StatefulWidget {
  @override
  _CivilcodState createState() => _CivilcodState();
}

class _CivilcodState extends State<Ececod> {
  showAlertDialog(BuildContext context) {
