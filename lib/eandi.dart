...
class Eandi extends StatefulWidget {
  Eandi({Key key,this.uid}):super(key:key);
  final String uid;
  @override
  _MechState createState() => _MechState();
}

class _MechState extends State<Eandi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("ORKESTRIM",style: TextStyle(color: Colors.black,fontSize: 25),),
          ...
          children: <Widget>[
                    ...
                    children: <Widget>[
                      ...
                      Container(
                          child: Column(
                            children: [
                              Container(
                                child: Text("ORKESTRIM' 2021",style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,color: Colors.white)) ,
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Firestore.instance.collection('users').document(
                                        widget.uid).collection('eandi').add({
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>Eandievent()),
                );
              },
              child: Container(
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>Eandicod()),
                );
              },
              child: Container(
                // padding: EdgeInsets.fromLTRB(10, 10, 10, 5),
...
class Eandievent extends StatefulWidget {
  @override
  _CivileventState createState() => _CivileventState();
}

class _CivileventState extends State<Eandievent> {
...
//coordinators
class Eandicod extends StatefulWidget {
  @override
  _CivilcodState createState() => _CivilcodState();
}

class _CivilcodState extends State<Eandicod> {
  showAlertDialog(BuildContext context) {
