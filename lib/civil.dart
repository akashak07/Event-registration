...
class Civil extends StatefulWidget {
  Civil({Key key, this.uid}) : super(key: key);
  final String uid;
...
class _MechState extends State<Civil> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("CONSTURO",style: TextStyle(color: Colors.black,fontSize: 25),),
          ...
          children: <Widget>[
                    ...
                    children: <Widget>[
                      ...
                      Container(
                          child: Column(
                            children: [
                              Container(
                                child: Text("CONSTURO' 2021",style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,color: Colors.white)) ,
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                    Firestore.instance.collection('users').document(
                                        widget.uid).collection('civil').add({
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Civilevent()),
                );
              },
              child: Container(
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>Civilcod()),
                );
              },
              child: Container(
                // padding: EdgeInsets.fromLTRB(10, 10, 10, 5),
...
//events page
class Civilevent extends StatefulWidget {
  @override
  _CivileventState createState() => _CivileventState();
}

class _CivileventState extends State<Civilevent> {
...
//coordinators
class Civilcod extends StatefulWidget {
  @override
  _CivilcodState createState() => _CivilcodState();
}

class _CivilcodState extends State<Civilcod> {
  showAlertDialog(BuildContext context) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Cordinator's",style: TextStyle(color: Colors.black,fontSize: 25),),
        backgroundColor: Colors.white,
        centerTitle: true,
        leading: IconButton(
          icon: Icon(Icons.arrow_back_ios,color: Colors.black,size: 30,),
