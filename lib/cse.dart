...
class Cse extends StatefulWidget {
  Cse({Key key,this.uid}):super(key:key);
  final String uid;
  @override
  _MechState createState() => _MechState();
}

class _MechState extends State<Cse> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("CYBORG",style: TextStyle(color: Colors.black,fontSize: 25),),
          ...
          children: <Widget>[
                    ...
                    children: <Widget>[
                      ...
                      Container(
                          child: Column(
                            children: [
                              Container(
                                child: Text("CYBORG' 2021",style: TextStyle(fontSize: 40,fontWeight: FontWeight.bold,color: Colors.white)) ,
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>Cseevent()),
                );
              },
              child: Container(
            ...
            GestureDetector(
              onTap: (){
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) =>Csecod()),
                );
              },
              child: Container(
                // padding: EdgeInsets.fromLTRB(10, 10, 10, 5),
...
class Cseevent extends StatefulWidget {
  @override
  _CivileventState createState() => _CivileventState();
}

class _CivileventState extends State<Cseevent> {
...
//coordinators
class Csecod extends StatefulWidget {
  @override
  _CivilcodState createState() => _CivilcodState();
}

class _CivilcodState extends State<Csecod> {
  showAlertDialog(BuildContext context) {
